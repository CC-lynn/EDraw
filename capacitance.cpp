...
void capacitance::save(QTextStream& stream, mygroup* group)
{
    QPointF pos = group->pos();
    stream << "<g id=\"CAPACITANCE\" fill=\"none\" stroke=\"black\" stroke-width=\"1\" fill-rule=\"evenodd\" stroke-linecap=\"square\" stroke-linejoin=\"bevel\" transform=\"matrix(1,0,0,1,0,0)\">\n\n";
...
mygroup* capacitance::load(QTextStream &stream)
{
    QString line;
    QStringList list;
...
mygroup* capacitance::drawing()
{
    ...
    QGraphicsLineItem * line3 = new QGraphicsLineItem(point.x(),point.y()-10,point.x(),point.y()-30);
